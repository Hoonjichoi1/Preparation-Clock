...
## Instruction
- Start by adding a task by pressing "a" → enter name and time.
- After adding all tasks, press "t" and enter departing time in form of 24 hours HH:MM,
  then you can check the estimate time to start preparing. 
- If you want to remove task, press "r" and enter the name.
- If you want to view tasks you have so far in list, press "v". 
